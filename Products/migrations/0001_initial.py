# Generated by Django 4.0.5 on 2022-08-15 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Carec_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.t_carac_detail')),
                ('Prod_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.t_product')),
            ],
        ),
        migrations.AddField(
            model_name='t_carac_detail',
            name='Carac_Id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.t_characteristic'),
        ),
    ]
